...
export function MeetingContainer({
  ...
  return (
    <div className=" fixed rounded-xl mx-auto w-[80%] h-[93%] overflow-x-scroll my-auto">
      <div ref={containerRef} className="h-full flex flex-col bg-transparent">
        {typeof localParticipantAllowedJoin === "boolean" ? (
          localParticipantAllowedJoin ? (
            <>
              <div className={` flex flex-1 flex-row bg-transparent `}>
